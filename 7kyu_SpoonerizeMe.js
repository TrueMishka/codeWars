...
function spoonerize(words) {
    let sliceWords = words.split(' ');
    let firstWordLetter = sliceWords[0].charAt(0);
    let lastWordPosition = sliceWords.length-1;
    let lastWordLetter = sliceWords[sliceWords.length-1].charAt(0);
    sliceWords[0] = lastWordLetter + sliceWords[0].substring(1, sliceWords[0].length);
    sliceWords[lastWordPosition] = firstWordLetter + sliceWords[lastWordPosition].substring(1, sliceWords[lastWordPosition].length);
